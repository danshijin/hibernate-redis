...
public class JedisClient {
    ...
    public JedisClient(Pool<Jedis> jedisPool, int expiryInSeconds) {
        ...
        try {
			dataSourceContextHolderKey = (DataSourceContextHolderKey) Class.forName("com.smm.ctrm.bo.DataSourceContextHolderKeyImpl").newInstance();
		} catch (Exception e) {
    ...
    private byte[] rawKey(final Object key) {
        return keySerializer.serialize(key.toString() + dataSourceContextHolderKey.getKey());
    }
